...
function makeplo(id,fatherId,dir,resolve,showFile,random){
    let isRandom=random
    ...
    let tmp_name=''
     ...
     let uploader = new plupload.Uploader({
        ...
        init:{
            ...
            BeforeUpload: function(up, file,isRandom) {
    ...
    uploader.calculate_object_name=function(filename)
        {
            if (g_object_name_type == 'local_name')
            {
                ...
                g_object_name = key +new Date().getTime()+ filename
...
//创建ulpload示例
export function upFile(id,fatherId,dir,showFile,random){
    return new Promise((resolve, reject)=>{
        makeplo(id,fatherId,dir,resolve,showFile,random)
